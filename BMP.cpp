...
void BMP::shifr(std::string word) {
    ...
    for (int i = 0; i < word.length(); i++) 
    {
        ...
        {
            m_pixels[6][space + 3].g++;
            m_pixels[6][space + 2].g++;
            m_pixels[6][space + 1].g++;
            m_pixels[5][space].g++;
            m_pixels[4][space].g++;
            m_pixels[3][space + 2].g++;
            m_pixels[3][space + 1].g++;
            m_pixels[2][space + 3].g++;
            m_pixels[1][space + 3].g++;
            m_pixels[0][space + 2].g++;
            m_pixels[0][space + 1].g++;
            m_pixels[0][space + 0].g++;
        }
        if (word[i] == 'E' || word[i] == 'e') 
        {
            ...
            m_pixels[3][space + 1].g++;
            m_pixels[3][space + 2].g++;
            m_pixels[3][space + 3].g++;

            m_pixels[0][space + 1].g++;
            m_pixels[0][space + 2].g++;
            m_pixels[0][space + 3].g++;
        }
        ...
        if (word[i] == 'R' || word[i] == 'r') 
        {
            ...
            m_pixels[6][space + 1].g++;
            m_pixels[6][space + 2].g++;
            m_pixels[5][space + 3].g++;
            m_pixels[4][space + 3].g++;
            m_pixels[3][space + 2].g++;
            m_pixels[3][space + 1].g++;

            m_pixels[2][space + 1].g++;
            m_pixels[1][space + 2].g++;
            m_pixels[0][space + 3].g++;
        }
        ...
        if (word[i] == 'G' || word[i] == 'g')
        {
            ...
            m_pixels[1][space + 3].g++;
            m_pixels[2][space + 3].g++;
            m_pixels[2][space + 2].g++;
        }

        if (word[i] == 'A' || word[i] == 'a')
        {
            m_pixels[6][space + 3].g++;
            m_pixels[5][space + 2].g++;
            m_pixels[4][space + 2].g++;
            m_pixels[3][space + 1].g++;
            m_pixels[2][space + 1].g++;
            m_pixels[1][space + 0].g++;
            m_pixels[0][space + 0].g++;

            m_pixels[5][space + 4].g++;
            m_pixels[4][space + 4].g++;
            m_pixels[3][space + 5].g++;
            m_pixels[2][space + 5].g++;
            m_pixels[1][space + 6].g++;
            m_pixels[0][space + 6].g++;

            m_pixels[2][space + 2].g++;
            m_pixels[2][space + 3].g++;
            m_pixels[2][space + 4].g++;
        }
